/**
 * AFKmate 3D Renovation — Main JavaScript
 * Lenis Smooth Scroll + GSAP ScrollTrigger + 3D Effects
 */
...
(function () {
    ...
    if (codeWindow) {
        const wrapper = codeWindow.closest('.code-window-wrapper');
        ...
        heroVisual.addEventListener('mousemove', (e) => {
            ...
            // Float elements parallax (opposite direction)
    ...
    console.log('AFKmate 3D Renovation initialized ✨');
})();
